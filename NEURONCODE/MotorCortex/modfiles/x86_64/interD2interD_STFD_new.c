...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 interD2interD_STFD /home/mwsrgf/research/FengM1/NEURONCODE/MotorCortex/x86_64/interD2interD_STFD_new.mod\n");
 ...
 v=_v;
{
  ...
  ica = _ion_ica;
 { error =  release();
 if(error){fprintf(stderr,"at line 184 in file interD2interD_STFD_new.mod:\n	 \n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mwsrgf/research/FengM1/NEURONCODE/MotorCortex/modfiles/interD2interD_STFD_new.mod";
static const char* nmodl_file_text = 
