...
#define nrn_init _nrn_init__capoolCA3
#define _nrn_initial _nrn_initial__capoolCA3
#define nrn_cur _nrn_cur__capoolCA3
#define _nrn_current _nrn_current__capoolCA3
#define nrn_jacob _nrn_jacob__capoolCA3
#define nrn_state _nrn_state__capoolCA3
#define _net_receive _net_receive__capoolCA3 
#define states states__capoolCA3 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_capoolCA3", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define pi pi_capoolCA3
 double pi = 3.14159;
#define w w_capoolCA3
 double w = 1;
#define z z_capoolCA3
 double z = 2;
 ...
 "pi_capoolCA3", &pi_capoolCA3,
 "w_capoolCA3", &w_capoolCA3,
 "z_capoolCA3", &z_capoolCA3,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 capoolCA3 /home/mwsrgf/research/FengM1/NEURONCODE/MotorCortex/x86_64/capoolCA3.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mwsrgf/research/FengM1/NEURONCODE/MotorCortex/modfiles/capoolCA3.mod";
static const char* nmodl_file_text = 
