...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 pyrD2interD_STFD /home/mwsrgf/research/FengM1/NEURONCODE/MotorCortex/x86_64/pyrD2interD_STFD.mod\n");
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  release();
 if(error){fprintf(stderr,"at line 161 in file pyrD2interD_STFD.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mwsrgf/research/FengM1/NEURONCODE/MotorCortex/modfiles/pyrD2interD_STFD.mod";
static const char* nmodl_file_text = 
  ...
  "        tauF = 1 (ms) < 1e-9, 1e9 >\n"
  "        d1 = 0.6 (1) < 0, 1 >: 0.95 (1) < 0, 1 >     : fast depression\n"
  "        tauD1 = 300 (ms) < 1e-9, 1e9 >\n"
  "        d2 = 0.5 (1) < 0, 1 > : 0.9 (1) < 0, 1 >     : slow depression\n"
