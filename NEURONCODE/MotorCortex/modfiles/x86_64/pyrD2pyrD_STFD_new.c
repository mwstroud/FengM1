...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 pyrD2pyrD_STFD /home/mwsrgf/research/FengM1/NEURONCODE/MotorCortex/x86_64/pyrD2pyrD_STFD_new.mod\n");
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  release();
 if(error){fprintf(stderr,"at line 168 in file pyrD2pyrD_STFD_new.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mwsrgf/research/FengM1/NEURONCODE/MotorCortex/modfiles/pyrD2pyrD_STFD_new.mod";
static const char* nmodl_file_text = 
