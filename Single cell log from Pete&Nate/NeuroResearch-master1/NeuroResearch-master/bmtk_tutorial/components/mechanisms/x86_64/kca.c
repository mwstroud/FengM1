...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 kca /home/mizzou/Documents/NeuroResearch/bmtk_tutorial/components/mechanisms/modfiles/x86_64/kca.mod\n");
...
static int  rate ( _threadargsprotocomma_ double _lv , double _lcai ) {
    cinf = ( ( _lcai ) / ( _lcai + 0.003 ) ) * ( ( 1.0 ) / ( 1.0 + ( exp ( - ( _lv + 28.3 ) / ( 12.6 ) ) ) ) ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/Documents/NeuroResearch/bmtk_tutorial/components/mechanisms/modfiles/kca.mod";
static const char* nmodl_file_text = 
