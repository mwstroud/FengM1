...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kdr /home/mizzou/Documents/NeuroResearch/bmtk_tutorial/components/mechanisms/modfiles/x86_64/kdr.mod\n");
...
static int  rate ( _threadargsprotocomma_ double _lv ) {
    inf = 1.0 / ( 1.0 + ( exp ( ( _lv + 12.3 ) / ( - 11.8 ) ) ) ) ;
   tau = 14.4 - 12.8 / ( 1.0 + ( exp ( ( _lv + 28.3 ) / ( - 19.2 ) ) ) ) ;
     return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/Documents/NeuroResearch/bmtk_tutorial/components/mechanisms/modfiles/kdr.mod";
static const char* nmodl_file_text = 
