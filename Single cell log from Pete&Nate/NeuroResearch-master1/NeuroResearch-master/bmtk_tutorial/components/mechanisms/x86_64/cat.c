...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 cat /home/mizzou/Documents/NeuroResearch/bmtk_tutorial/components/mechanisms/modfiles/x86_64/cat.mod\n");
...
static int  rate ( _threadargsprotocomma_ double _lv ) {
    uinf = 1.0 / ( 1.0 + ( exp ( ( _lv + 27.1 ) / ( - 7.2 ) ) ) ) ;
   utau = ( 43.4 - 42.6 / ( 1.0 + ( exp ( ( _lv + 68.1 ) / ( - 20.5 ) ) ) ) ) ;
   zinf = 1.0 / ( 1.0 + ( exp ( ( _lv + 32.1 ) / ( 5.5 ) ) ) ) ;
   ztau = ( 210.0 - 179.6 / ( 1.0 + ( exp ( ( _lv + 55.0 ) / ( - 16.9 ) ) ) ) ) ;
     return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/Documents/NeuroResearch/bmtk_tutorial/components/mechanisms/modfiles/cat.mod";
static const char* nmodl_file_text = 
