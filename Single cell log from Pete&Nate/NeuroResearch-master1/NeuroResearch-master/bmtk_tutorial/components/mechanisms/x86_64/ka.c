...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 ka /home/mizzou/Documents/NeuroResearch/bmtk_tutorial/components/mechanisms/modfiles/x86_64/ka.mod\n");
...
static int  rate ( _threadargsprotocomma_ double _lv ) {
    ainf = 1.0 / ( 1.0 + ( exp ( ( _lv + 27.2 ) / ( - 8.7 ) ) ) ) ;
   atau = ( 23.2 - 20.8 / ( 1.0 + ( exp ( ( _lv + 32.9 ) / ( - 15.2 ) ) ) ) ) ;
   binf = 1.0 / ( 1.0 + ( exp ( ( _lv + 56.9 ) / ( 4.9 ) ) ) ) ;
   btau = ( 77.2 - 58.4 / ( 1.0 + ( exp ( ( _lv + 38.9 ) / ( - 26.5 ) ) ) ) ) ;
     return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/Documents/NeuroResearch/bmtk_tutorial/components/mechanisms/modfiles/ka.mod";
static const char* nmodl_file_text = 
  ": A-type  K+ CHANNEL (KA)\n"
  "\n"
  "NEURON {\n"
