...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 na /home/mizzou/Documents/NeuroResearch/bmtk_tutorial/components/mechanisms/modfiles/x86_64/na.mod\n");
...
static int  rate ( _threadargsprotocomma_ double _lv ) {
    minf = 1.0 / ( 1.0 + ( exp ( ( _lv + 25.5 ) / ( - 5.29 ) ) ) ) ;
   mtau = ( 2.64 - 2.52 / ( 1.0 + ( exp ( ( _lv + 120.0 ) / ( - 25.0 ) ) ) ) ) ;
   hinf = 1.0 / ( 1.0 + ( exp ( ( _lv + 48.9 ) / ( 5.18 ) ) ) ) ;
   htau = ( 1.34 / ( 1.0 + ( exp ( ( _lv + 62.9 ) / ( - 10.0 ) ) ) ) ) * ( 1.5 + 1.0 / ( 1.0 + ( exp ( ( _lv + 34.9 ) / ( 3.6 ) ) ) ) ) ;
     return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/Documents/NeuroResearch/bmtk_tutorial/components/mechanisms/modfiles/na.mod";
static const char* nmodl_file_text = 
