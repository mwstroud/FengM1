...
#define nrn_init _nrn_init__ncaCA3
#define _nrn_initial _nrn_initial__ncaCA3
#define nrn_cur _nrn_cur__ncaCA3
#define _nrn_current _nrn_current__ncaCA3
#define nrn_jacob _nrn_jacob__ncaCA3
#define nrn_state _nrn_state__ncaCA3
#define _net_receive _net_receive__ncaCA3 
#define _f_trates _f_trates__ncaCA3 
#define rates rates__ncaCA3 
#define states states__ncaCA3 
#define trates trates__ncaCA3 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_ncaCA3", _hoc_setdata,
 "rates_ncaCA3", _hoc_rates,
 "states_ncaCA3", _hoc_states,
 "trates_ncaCA3", _hoc_trates,
 "vtrap_ncaCA3", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_ncaCA3
 extern double vtrap( double , double );
 /* declare global and static user variables */
#define usetable usetable_ncaCA3
 double usetable = 1;
 ...
 "usetable_ncaCA3", &usetable_ncaCA3,
 0,0
};
...
static int _ode_count(int _type){ hoc_execerror("ncaCA3", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
  enca = _ion_enca;
 { error =  states();
 if(error){fprintf(stderr,"at line 53 in file ncaCA3.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 } }}
