...
#define nrn_init _nrn_init__lcaBC
#define _nrn_initial _nrn_initial__lcaBC
#define nrn_cur _nrn_cur__lcaBC
#define _nrn_current _nrn_current__lcaBC
#define nrn_jacob _nrn_jacob__lcaBC
#define nrn_state _nrn_state__lcaBC
#define _net_receive _net_receive__lcaBC 
#define rate rate__lcaBC 
#define state state__lcaBC 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_lcaBC", _hoc_setdata,
 "KTF_lcaBC", _hoc_KTF,
 "alp_lcaBC", _hoc_alp,
 "bet_lcaBC", _hoc_bet,
 "efun_lcaBC", _hoc_efun,
 "ghk_lcaBC", _hoc_ghk,
 "h2_lcaBC", _hoc_h2,
 "rate_lcaBC", _hoc_rate,
 0, 0
};
#define KTF KTF_lcaBC
#define _f_bet _f_bet_lcaBC
#define _f_alp _f_alp_lcaBC
#define alp alp_lcaBC
#define bet bet_lcaBC
#define efun efun_lcaBC
#define ghk ghk_lcaBC
#define h2 h2_lcaBC
...
#define ki ki_lcaBC
 double ki = 0.001;
#define matu matu_lcaBC
 double matu = 0;
#define minf minf_lcaBC
 double minf = 0;
#define tfa tfa_lcaBC
 double tfa = 1;
#define usetable usetable_lcaBC
 double usetable = 1;
 ...
 "ki_lcaBC", &ki_lcaBC,
 "tfa_lcaBC", &tfa_lcaBC,
 "minf_lcaBC", &minf_lcaBC,
 "matu_lcaBC", &matu_lcaBC,
 "usetable_lcaBC", &usetable_lcaBC,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 lcaBC /home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/x86_64/Lca_BC.mod\n");
 ...
 v=_v;
{
  ...
  cao = _ion_cao;
 { error =  state();
 if(error){fprintf(stderr,"at line 56 in file Lca_BC.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/modfiles/Lca_BC.mod";
static const char* nmodl_file_text = 
