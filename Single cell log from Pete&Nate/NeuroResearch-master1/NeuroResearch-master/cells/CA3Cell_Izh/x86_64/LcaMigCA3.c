...
#define nrn_init _nrn_init__lcaCA3
#define _nrn_initial _nrn_initial__lcaCA3
#define nrn_cur _nrn_cur__lcaCA3
#define _nrn_current _nrn_current__lcaCA3
#define nrn_jacob _nrn_jacob__lcaCA3
#define nrn_state _nrn_state__lcaCA3
#define _net_receive _net_receive__lcaCA3 
#define rate rate__lcaCA3 
#define state state__lcaCA3 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_lcaCA3", _hoc_setdata,
 "KTF_lcaCA3", _hoc_KTF,
 "alp_lcaCA3", _hoc_alp,
 "bet_lcaCA3", _hoc_bet,
 "efun_lcaCA3", _hoc_efun,
 "ghk_lcaCA3", _hoc_ghk,
 "h2_lcaCA3", _hoc_h2,
 "rate_lcaCA3", _hoc_rate,
 0, 0
};
#define KTF KTF_lcaCA3
#define _f_bet _f_bet_lcaCA3
#define _f_alp _f_alp_lcaCA3
#define alp alp_lcaCA3
#define bet bet_lcaCA3
#define efun efun_lcaCA3
#define ghk ghk_lcaCA3
#define h2 h2_lcaCA3
...
#define ki ki_lcaCA3
 double ki = 0.001;
#define matu matu_lcaCA3
 double matu = 0;
#define minf minf_lcaCA3
 double minf = 0;
#define tfa tfa_lcaCA3
 double tfa = 1;
#define usetable usetable_lcaCA3
 double usetable = 1;
 ...
 "ki_lcaCA3", &ki_lcaCA3,
 "tfa_lcaCA3", &tfa_lcaCA3,
 "minf_lcaCA3", &minf_lcaCA3,
 "matu_lcaCA3", &matu_lcaCA3,
 "usetable_lcaCA3", &usetable_lcaCA3,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 lcaCA3 /home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/x86_64/LcaMigCA3.mod\n");
 ...
 v=_v;
{
  ...
  cao = _ion_cao;
 { error =  state();
 if(error){fprintf(stderr,"at line 56 in file LcaMigCA3.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/modfiles/LcaMigCA3.mod";
static const char* nmodl_file_text = 
