...
#define nrn_init _nrn_init__ichan2CA3
#define _nrn_initial _nrn_initial__ichan2CA3
#define nrn_cur _nrn_cur__ichan2CA3
#define _nrn_current _nrn_current__ichan2CA3
#define nrn_jacob _nrn_jacob__ichan2CA3
#define nrn_state _nrn_state__ichan2CA3
#define _net_receive _net_receive__ichan2CA3 
#define _f_trates _f_trates__ichan2CA3 
#define rates rates__ichan2CA3 
#define states states__ichan2CA3 
#define trates trates__ichan2CA3 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_ichan2CA3", _hoc_setdata,
 "rates_ichan2CA3", _hoc_rates,
 "states_ichan2CA3", _hoc_states,
 "trates_ichan2CA3", _hoc_trates,
 "vtrap_ichan2CA3", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_ichan2CA3
 extern double vtrap( double , double );
 /* declare global and static user variables */
#define usetable usetable_ichan2CA3
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_ichan2CA3", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gnatbar_ichan2CA3", "mho/cm2",
 "gkfbar_ichan2CA3", "mho/cm2",
 "gksbar_ichan2CA3", "mho/cm2",
 "gl_ichan2CA3", "mho/cm2",
 "el_ichan2CA3", "mV",
 "gnat_ichan2CA3", "mho/cm2",
 "gkf_ichan2CA3", "mho/cm2",
 "gks_ichan2CA3", "mho/cm2",
 "inat_ichan2CA3", "mA/cm2",
 "ikf_ichan2CA3", "mA/cm2",
 "iks_ichan2CA3", "mA/cm2",
 "il_ichan2CA3", "mA/cm2",
 "mtau_ichan2CA3", "ms",
 "htau_ichan2CA3", "ms",
 "nftau_ichan2CA3", "ms",
 ...
 "usetable_ichan2CA3", &usetable_ichan2CA3,
 0,0
};
...
static int _ode_count(int _type){ hoc_execerror("ichan2CA3", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
  ...
  eks = _ion_eks;
 { error =  states();
 if(error){fprintf(stderr,"at line 72 in file ichan2CA3.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 }   }}
