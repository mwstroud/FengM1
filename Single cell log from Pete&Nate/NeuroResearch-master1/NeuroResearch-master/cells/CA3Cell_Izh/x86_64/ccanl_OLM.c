...
#define nrn_init _nrn_init__ccanlOLM
#define _nrn_initial _nrn_initial__ccanlOLM
#define nrn_cur _nrn_cur__ccanlOLM
#define _nrn_current _nrn_current__ccanlOLM
#define nrn_jacob _nrn_jacob__ccanlOLM
#define nrn_state _nrn_state__ccanlOLM
#define _net_receive _net_receive__ccanlOLM 
#define integrate integrate__ccanlOLM 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_ccanlOLM", _hoc_setdata,
 "ktf_ccanlOLM", _hoc_ktf,
 0, 0
};
#define ktf ktf_ccanlOLM
 extern double ktf( );
 /* declare global and static user variables */
#define cao cao_ccanlOLM
 double cao = 2;
#define depth depth_ccanlOLM
 double depth = 200;
#define ica ica_ccanlOLM
 double ica = 0;
 ...
 "depth_ccanlOLM", &depth_ccanlOLM,
 "cao_ccanlOLM", &cao_ccanlOLM,
 "ica_ccanlOLM", &ica_ccanlOLM,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 12, "cvodeieq");
 	...
 	ivoc_help("help ?1 ccanlOLM /home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/x86_64/ccanl_OLM.mod\n");
...
_deriv1_advance = 0;
 if(error){fprintf(stderr,"at line 72 in file ccanl_OLM.mod:\n	SOLVE integrate METHOD derivimplicit\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 3; ++_i) {
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/modfiles/ccanl_OLM.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
