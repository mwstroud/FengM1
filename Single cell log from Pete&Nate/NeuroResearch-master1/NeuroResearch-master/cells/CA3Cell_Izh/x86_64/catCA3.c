...
#define nrn_init _nrn_init__catCA3
#define _nrn_initial _nrn_initial__catCA3
#define nrn_cur _nrn_cur__catCA3
#define _nrn_current _nrn_current__catCA3
#define nrn_jacob _nrn_jacob__catCA3
#define nrn_state _nrn_state__catCA3
#define _net_receive _net_receive__catCA3 
#define states states__catCA3 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_catCA3", _hoc_setdata,
 "KTF_catCA3", _hoc_KTF,
 "efun_catCA3", _hoc_efun,
 "ghk_catCA3", _hoc_ghk,
 "h_tau_catCA3", _hoc_h_tau,
 "hinf_catCA3", _hoc_hinf,
 "m_tau_catCA3", _hoc_m_tau,
 "minf_catCA3", _hoc_minf,
 0, 0
};
#define KTF KTF_catCA3
#define _f_h_tau _f_h_tau_catCA3
#define _f_m_tau _f_m_tau_catCA3
#define _f_minf _f_minf_catCA3
#define _f_hinf _f_hinf_catCA3
#define efun efun_catCA3
#define ghk ghk_catCA3
#define h_tau h_tau_catCA3
#define hinf hinf_catCA3
#define m_tau m_tau_catCA3
#define minf minf_catCA3
...
static void _check_m_tau(double*, Datum*, Datum*, _NrnThread*); 
static void _check_h_tau(double*, Datum*, Datum*, _NrnThread*); 
...
#define usetable usetable_catCA3
 double usetable = 1;
 ...
 "usetable_catCA3", &usetable_catCA3,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 catCA3 /home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/x86_64/catCA3.mod\n");
...
static void _hoc_minf(void) {
 ...
 static double _mfac_m_tau, _tmin_m_tau;
  static void _check_m_tau(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {
  static int _maktable=1; int _i, _j, _ix = 0;
  double _xi, _tmax;
  if (!usetable) {return;}
  if (_maktable) { double _x, _dx; _maktable=0;
 ...
 double m_tau(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _lv) { 
#if 0
_check_m_tau(_p, _ppvar, _thread, _nt);
#endif
 ...
 static double _n_m_tau(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _lv){ int _i, _j;
 double _xi, _theta;
 if (!usetable) {
...
static void _hoc_m_tau(void) {
 ...
 static double _mfac_h_tau, _tmin_h_tau;
  static void _check_h_tau(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {
  static int _maktable=1; int _i, _j, _ix = 0;
  double _xi, _tmax;
  if (!usetable) {return;}
  if (_maktable) { double _x, _dx; _maktable=0;
 ...
 double h_tau(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _lv) { 
#if 0
_check_h_tau(_p, _ppvar, _thread, _nt);
#endif
 ...
 static double _n_h_tau(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _lv){ int _i, _j;
 double _xi, _theta;
 if (!usetable) {
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/modfiles/catCA3.mod";
static const char* nmodl_file_text = 
