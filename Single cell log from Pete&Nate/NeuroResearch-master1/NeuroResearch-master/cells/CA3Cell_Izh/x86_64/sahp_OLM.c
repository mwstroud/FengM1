...
#define nrn_init _nrn_init__sAHPOLM
#define _nrn_initial _nrn_initial__sAHPOLM
#define nrn_cur _nrn_cur__sAHPOLM
#define _nrn_current _nrn_current__sAHPOLM
#define nrn_jacob _nrn_jacob__sAHPOLM
#define nrn_state _nrn_state__sAHPOLM
#define _net_receive _net_receive__sAHPOLM 
#define rate rate__sAHPOLM 
#define states states__sAHPOLM 
...
#define _ion_lcai	*_ppvar[3]._pval
#define _ion_tcai	*_ppvar[4]._pval
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_sAHPOLM", _hoc_setdata,
 "cbet_sAHPOLM", _hoc_cbet,
 "calf_sAHPOLM", _hoc_calf,
 "rate_sAHPOLM", _hoc_rate,
 0, 0
};
#define cbet cbet_sAHPOLM
#define calf calf_sAHPOLM
...
#define _gth 0
#define cai_sAHPOLM _thread1data[0]
...
static void nrn_alloc(Prop* _prop) {
 ...
 nrn_promote(prop_ion, 1, 0);
 	_ppvar[3]._pval = &prop_ion->param[1]; /* lcai */
 prop_ion = need_memb(_tca_sym);
 nrn_promote(prop_ion, 1, 0);
 	_ppvar[4]._pval = &prop_ion->param[1]; /* tcai */
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 sAHPOLM /home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/x86_64/sahp_OLM.mod\n");
...
static int  rate ( _threadargsprotocomma_ double _lv , double _lcai ) {
  ...
  _lca = calf ( _threadargscomma_ _lv , _lcai ) ;
   _lcb = cbet ( _threadargscomma_ _lv , _lcai ) ;
   _lcsum = _lca + _lcb ;
   cinf = _lca / _lcsum ;
   ctau = 48.0 ;
     return 0; }
...
static void _thread_cleanup(Datum* _thread) {
 ...
 static void _update_ion_pointer(Datum* _ppvar) {
   ...
   nrn_update_ion_pointer(_lca_sym, _ppvar, 3, 1);
   nrn_update_ion_pointer(_tca_sym, _ppvar, 4, 1);
 }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/modfiles/sahp_OLM.mod";
static const char* nmodl_file_text = 
