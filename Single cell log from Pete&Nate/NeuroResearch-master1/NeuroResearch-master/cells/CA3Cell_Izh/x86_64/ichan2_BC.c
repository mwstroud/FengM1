...
#define nrn_init _nrn_init__ichan2BC
#define _nrn_initial _nrn_initial__ichan2BC
#define nrn_cur _nrn_cur__ichan2BC
#define _nrn_current _nrn_current__ichan2BC
#define nrn_jacob _nrn_jacob__ichan2BC
#define nrn_state _nrn_state__ichan2BC
#define _net_receive _net_receive__ichan2BC 
#define _f_trates _f_trates__ichan2BC 
#define rates rates__ichan2BC 
#define states states__ichan2BC 
#define trates trates__ichan2BC 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_ichan2BC", _hoc_setdata,
 "rates_ichan2BC", _hoc_rates,
 "states_ichan2BC", _hoc_states,
 "trates_ichan2BC", _hoc_trates,
 "vtrap_ichan2BC", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_ichan2BC
 extern double vtrap( double , double );
 /* declare global and static user variables */
#define usetable usetable_ichan2BC
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_ichan2BC", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gnatbar_ichan2BC", "mho/cm2",
 "gkfbar_ichan2BC", "mho/cm2",
 "gksbar_ichan2BC", "mho/cm2",
 "gl_ichan2BC", "mho/cm2",
 "el_ichan2BC", "mV",
 "gnat_ichan2BC", "mho/cm2",
 "gkf_ichan2BC", "mho/cm2",
 "gks_ichan2BC", "mho/cm2",
 "inat_ichan2BC", "mA/cm2",
 "ikf_ichan2BC", "mA/cm2",
 "iks_ichan2BC", "mA/cm2",
 "il_ichan2BC", "mA/cm2",
 "mtau_ichan2BC", "ms",
 ...
 "usetable_ichan2BC", &usetable_ichan2BC,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 8, "ks_ion");
 	...
 	ivoc_help("help ?1 ichan2BC /home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/x86_64/ichan2_BC.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("ichan2BC", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
  ...
  eks = _ion_eks;
 { error =  states();
 if(error){fprintf(stderr,"at line 72 in file ichan2_BC.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 }   }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/modfiles/ichan2_BC.mod";
static const char* nmodl_file_text = 
  "TITLE ichan2.mod  \n"
  " \n"
  "COMMENT\n"
