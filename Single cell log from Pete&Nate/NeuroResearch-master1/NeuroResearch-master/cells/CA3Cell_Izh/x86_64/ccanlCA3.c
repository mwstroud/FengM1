...
#define nrn_init _nrn_init__ccanlCA3
#define _nrn_initial _nrn_initial__ccanlCA3
#define nrn_cur _nrn_cur__ccanlCA3
#define _nrn_current _nrn_current__ccanlCA3
#define nrn_jacob _nrn_jacob__ccanlCA3
#define nrn_state _nrn_state__ccanlCA3
#define _net_receive _net_receive__ccanlCA3 
#define integrate integrate__ccanlCA3 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_ccanlCA3", _hoc_setdata,
 "ktf_ccanlCA3", _hoc_ktf,
 0, 0
};
#define ktf ktf_ccanlCA3
 extern double ktf( );
 /* declare global and static user variables */
#define cao cao_ccanlCA3
 double cao = 2;
#define depth depth_ccanlCA3
 double depth = 200;
#define ica ica_ccanlCA3
 double ica = 0;
 ...
 "depth_ccanlCA3", &depth_ccanlCA3,
 "cao_ccanlCA3", &cao_ccanlCA3,
 "ica_ccanlCA3", &ica_ccanlCA3,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 12, "cvodeieq");
 	...
 	ivoc_help("help ?1 ccanlCA3 /home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/x86_64/ccanlCA3.mod\n");
...
_deriv1_advance = 0;
 if(error){fprintf(stderr,"at line 72 in file ccanlCA3.mod:\n	SOLVE integrate METHOD derivimplicit\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 3; ++_i) {
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/modfiles/ccanlCA3.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
