...
#define nrn_init _nrn_init__lcaDG
#define _nrn_initial _nrn_initial__lcaDG
#define nrn_cur _nrn_cur__lcaDG
#define _nrn_current _nrn_current__lcaDG
#define nrn_jacob _nrn_jacob__lcaDG
#define nrn_state _nrn_state__lcaDG
#define _net_receive _net_receive__lcaDG 
#define rate rate__lcaDG 
#define state state__lcaDG 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_lcaDG", _hoc_setdata,
 "KTF_lcaDG", _hoc_KTF,
 "alp_lcaDG", _hoc_alp,
 "bet_lcaDG", _hoc_bet,
 "efun_lcaDG", _hoc_efun,
 "ghk_lcaDG", _hoc_ghk,
 "h2_lcaDG", _hoc_h2,
 "rate_lcaDG", _hoc_rate,
 0, 0
};
#define KTF KTF_lcaDG
#define _f_bet _f_bet_lcaDG
#define _f_alp _f_alp_lcaDG
#define alp alp_lcaDG
#define bet bet_lcaDG
#define efun efun_lcaDG
#define ghk ghk_lcaDG
#define h2 h2_lcaDG
...
#define ki ki_lcaDG
 double ki = 0.001;
#define matu matu_lcaDG
 double matu = 0;
#define minf minf_lcaDG
 double minf = 0;
#define tfa tfa_lcaDG
 double tfa = 1;
#define usetable usetable_lcaDG
 double usetable = 1;
 ...
 "ki_lcaDG", &ki_lcaDG,
 "tfa_lcaDG", &tfa_lcaDG,
 "minf_lcaDG", &minf_lcaDG,
 "matu_lcaDG", &matu_lcaDG,
 "usetable_lcaDG", &usetable_lcaDG,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 lcaDG /home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/x86_64/LcaMig.mod\n");
 ...
 v=_v;
{
  ...
  cao = _ion_cao;
 { error =  state();
 if(error){fprintf(stderr,"at line 56 in file LcaMig.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/modfiles/LcaMig.mod";
static const char* nmodl_file_text = 
