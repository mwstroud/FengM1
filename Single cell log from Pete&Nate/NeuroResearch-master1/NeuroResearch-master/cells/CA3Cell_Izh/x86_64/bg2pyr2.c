...
#define nrn_init _nrn_init__bg2pyr2
#define _nrn_initial _nrn_initial__bg2pyr2
#define nrn_cur _nrn_cur__bg2pyr2
#define _nrn_current _nrn_current__bg2pyr2
#define nrn_jacob _nrn_jacob__bg2pyr2
#define nrn_state _nrn_state__bg2pyr2
#define _net_receive _net_receive__bg2pyr2 
#define states states__bg2pyr2 
