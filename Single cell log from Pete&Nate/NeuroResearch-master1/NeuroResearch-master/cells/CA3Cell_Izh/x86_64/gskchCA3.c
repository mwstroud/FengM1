...
#define nrn_init _nrn_init__gskchCA3
#define _nrn_initial _nrn_initial__gskchCA3
#define nrn_cur _nrn_cur__gskchCA3
#define _nrn_current _nrn_current__gskchCA3
#define nrn_jacob _nrn_jacob__gskchCA3
#define nrn_state _nrn_state__gskchCA3
#define _net_receive _net_receive__gskchCA3 
#define rate rate__gskchCA3 
#define state state__gskchCA3 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_gskchCA3", _hoc_setdata,
 "rate_gskchCA3", _hoc_rate,
 "state_gskchCA3", _hoc_state,
 0, 0
};
 /* declare global and static user variables */
#define cai cai_gskchCA3
 double cai = 0;
 ...
 "cai_gskchCA3", "mM",
 "gskbar_gskchCA3", "mho/cm2",
 "isk_gskchCA3", "mA/cm2",
 "gsk_gskchCA3", "mho/cm2",
 "qtau_gskchCA3", "ms",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "tca_ion");
 	...
 	ivoc_help("help ?1 gskchCA3 /home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/x86_64/gskchCA3.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("gskchCA3", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
  ...
  tcai = _ion_tcai;
 { error =  state();
 if(error){fprintf(stderr,"at line 47 in file gskchCA3.mod:\n	SOLVE state\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/modfiles/gskchCA3.mod";
static const char* nmodl_file_text = 
