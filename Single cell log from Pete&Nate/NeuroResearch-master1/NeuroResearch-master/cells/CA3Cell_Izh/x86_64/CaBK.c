...
#define nrn_init _nrn_init__cagkDG
#define _nrn_initial _nrn_initial__cagkDG
#define nrn_cur _nrn_cur__cagkDG
#define _nrn_current _nrn_current__cagkDG
#define nrn_jacob _nrn_jacob__cagkDG
#define nrn_state _nrn_state__cagkDG
#define _net_receive _net_receive__cagkDG 
#define rate rate__cagkDG 
#define state state__cagkDG 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_cagkDG", _hoc_setdata,
 "alp_cagkDG", _hoc_alp,
 "bet_cagkDG", _hoc_bet,
 "exp1_cagkDG", _hoc_exp1,
 "rate_cagkDG", _hoc_rate,
 0, 0
};
#define alp alp_cagkDG
#define bet bet_cagkDG
#define exp1 exp1_cagkDG
 extern double alp( double , double );
 extern double bet( double , double );
 extern double exp1( double , double , double );
 /* declare global and static user variables */
#define abar abar_cagkDG
 double abar = 0.28;
#define bbar bbar_cagkDG
 double bbar = 0.48;
#define cai cai_cagkDG
 double cai = 5e-05;
#define d2 d2_cagkDG
 double d2 = 1;
#define d1 d1_cagkDG
...
#define k1 k1_cagkDG
 double k1 = 0.00048;
#define otau otau_cagkDG
 double otau = 0;
#define oinf oinf_cagkDG
 double oinf = 0;
#define st st_cagkDG
 double st = 1;
 ...
 "cai_cagkDG", &cai_cagkDG,
 "d1_cagkDG", &d1_cagkDG,
 "d2_cagkDG", &d2_cagkDG,
 "k1_cagkDG", &k1_cagkDG,
 "k2_cagkDG", &k2_cagkDG,
 "abar_cagkDG", &abar_cagkDG,
 "bbar_cagkDG", &bbar_cagkDG,
 "st_cagkDG", &st_cagkDG,
 "oinf_cagkDG", &oinf_cagkDG,
 "otau_cagkDG", &otau_cagkDG,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "cvodeieq");
 	...
 	ivoc_help("help ?1 cagkDG /home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/x86_64/CaBK.mod\n");
 ...
 v=_v;
{
  ...
  ek = _ion_ek;
 { error =  state();
 if(error){fprintf(stderr,"at line 62 in file CaBK.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/modfiles/CaBK.mod";
static const char* nmodl_file_text = 
  "TITLE CaGk\n"
