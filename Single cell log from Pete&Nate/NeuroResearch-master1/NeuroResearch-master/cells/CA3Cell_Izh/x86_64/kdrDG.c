...
#define nrn_init _nrn_init__kdrDG
#define _nrn_initial _nrn_initial__kdrDG
#define nrn_cur _nrn_cur__kdrDG
#define _nrn_current _nrn_current__kdrDG
#define nrn_jacob _nrn_jacob__kdrDG
#define nrn_state _nrn_state__kdrDG
#define _net_receive _net_receive__kdrDG 
#define rates rates__kdrDG 
#define states states__kdrDG 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kdrDG", _hoc_setdata,
 "alpn_kdrDG", _hoc_alpn,
 "betn_kdrDG", _hoc_betn,
 "rates_kdrDG", _hoc_rates,
 0, 0
};
#define alpn alpn_kdrDG
#define betn betn_kdrDG
 extern double alpn( _threadargsprotocomma_ double );
 extern double betn( _threadargsprotocomma_ double );
 /* declare global and static user variables */
#define a0n a0n_kdrDG
 double a0n = 0.02;
#define gmn gmn_kdrDG
 double gmn = 0.7;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kdrDG /home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/x86_64/kdrDG.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/modfiles/kdrDG.mod";
static const char* nmodl_file_text = 
  "TITLE K-DR channel\n"
