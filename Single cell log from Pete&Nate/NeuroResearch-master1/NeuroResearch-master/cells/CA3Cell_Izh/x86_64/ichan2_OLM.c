...
#define nrn_init _nrn_init__ichan2OLM
#define _nrn_initial _nrn_initial__ichan2OLM
#define nrn_cur _nrn_cur__ichan2OLM
#define _nrn_current _nrn_current__ichan2OLM
#define nrn_jacob _nrn_jacob__ichan2OLM
#define nrn_state _nrn_state__ichan2OLM
#define _net_receive _net_receive__ichan2OLM 
#define _f_trates _f_trates__ichan2OLM 
#define rates rates__ichan2OLM 
#define states states__ichan2OLM 
#define trates trates__ichan2OLM 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_ichan2OLM", _hoc_setdata,
 "rates_ichan2OLM", _hoc_rates,
 "states_ichan2OLM", _hoc_states,
 "trates_ichan2OLM", _hoc_trates,
 "vtrap_ichan2OLM", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_ichan2OLM
 extern double vtrap( double , double );
 /* declare global and static user variables */
#define usetable usetable_ichan2OLM
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_ichan2OLM", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gnatbar_ichan2OLM", "mho/cm2",
 "gkfbar_ichan2OLM", "mho/cm2",
 "gksbar_ichan2OLM", "mho/cm2",
 "gl_ichan2OLM", "mho/cm2",
 "el_ichan2OLM", "mV",
 "gnat_ichan2OLM", "mho/cm2",
 "gkf_ichan2OLM", "mho/cm2",
 "gks_ichan2OLM", "mho/cm2",
 "inat_ichan2OLM", "mA/cm2",
 "ikf_ichan2OLM", "mA/cm2",
 "iks_ichan2OLM", "mA/cm2",
 "il_ichan2OLM", "mA/cm2",
 "mtau_ichan2OLM", "ms",
 "htau_ichan2OLM", "ms",
 "nftau_ichan2OLM", "ms",
 ...
 "usetable_ichan2OLM", &usetable_ichan2OLM,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 8, "ks_ion");
 	...
 	ivoc_help("help ?1 ichan2OLM /home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/x86_64/ichan2_OLM.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("ichan2OLM", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
  ...
  eks = _ion_eks;
 { error =  states();
 if(error){fprintf(stderr,"at line 72 in file ichan2_OLM.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 }   }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/modfiles/ichan2_OLM.mod";
static const char* nmodl_file_text = 
  "TITLE ichan2.mod  \n"
  " \n"
  "COMMENT\n"
