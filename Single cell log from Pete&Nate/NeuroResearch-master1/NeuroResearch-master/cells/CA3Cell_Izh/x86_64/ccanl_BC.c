...
#define nrn_init _nrn_init__ccanlBC
#define _nrn_initial _nrn_initial__ccanlBC
#define nrn_cur _nrn_cur__ccanlBC
#define _nrn_current _nrn_current__ccanlBC
#define nrn_jacob _nrn_jacob__ccanlBC
#define nrn_state _nrn_state__ccanlBC
#define _net_receive _net_receive__ccanlBC 
#define integrate integrate__ccanlBC 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_ccanlBC", _hoc_setdata,
 "ktf_ccanlBC", _hoc_ktf,
 0, 0
};
#define ktf ktf_ccanlBC
 extern double ktf( );
 /* declare global and static user variables */
#define cao cao_ccanlBC
 double cao = 2;
#define depth depth_ccanlBC
 double depth = 200;
#define ica ica_ccanlBC
 double ica = 0;
 ...
 "depth_ccanlBC", &depth_ccanlBC,
 "cao_ccanlBC", &cao_ccanlBC,
 "ica_ccanlBC", &ica_ccanlBC,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 12, "cvodeieq");
 	...
 	ivoc_help("help ?1 ccanlBC /home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/x86_64/ccanl_BC.mod\n");
...
_deriv1_advance = 0;
 if(error){fprintf(stderr,"at line 72 in file ccanl_BC.mod:\n	SOLVE integrate METHOD derivimplicit\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 3; ++_i) {
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/modfiles/ccanl_BC.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
