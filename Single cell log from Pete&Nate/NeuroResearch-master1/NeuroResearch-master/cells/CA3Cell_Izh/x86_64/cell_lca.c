...
#define ubet ubet_lca
#define ualf ualf_lca
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 lca /home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/x86_64/cell_lca.mod\n");
...
double ualf ( _threadargsprotocomma_ double _lv ) {
 ...
 _lva = 81.5 - _lv ;
   ...
   _lualf = 15.69 * _lva / ( exp ( _lva / 10.0 ) - 1.0 ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/modfiles/cell_lca.mod";
static const char* nmodl_file_text = 
