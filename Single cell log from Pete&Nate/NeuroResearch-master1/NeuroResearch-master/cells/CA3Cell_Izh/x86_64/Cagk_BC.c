...
#define nrn_init _nrn_init__cagkBC
#define _nrn_initial _nrn_initial__cagkBC
#define nrn_cur _nrn_cur__cagkBC
#define _nrn_current _nrn_current__cagkBC
#define nrn_jacob _nrn_jacob__cagkBC
#define nrn_state _nrn_state__cagkBC
#define _net_receive _net_receive__cagkBC 
#define rate rate__cagkBC 
#define state state__cagkBC 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_cagkBC", _hoc_setdata,
 "alp_cagkBC", _hoc_alp,
 "bet_cagkBC", _hoc_bet,
 "exp1_cagkBC", _hoc_exp1,
 "rate_cagkBC", _hoc_rate,
 0, 0
};
#define alp alp_cagkBC
#define bet bet_cagkBC
#define exp1 exp1_cagkBC
 extern double alp( double , double );
 extern double bet( double , double );
 extern double exp1( double , double , double );
 /* declare global and static user variables */
#define abar abar_cagkBC
 double abar = 0.28;
#define bbar bbar_cagkBC
 double bbar = 0.48;
#define cai cai_cagkBC
 double cai = 5e-05;
#define d2 d2_cagkBC
 double d2 = 1;
#define d1 d1_cagkBC
...
#define k1 k1_cagkBC
 double k1 = 0.00048;
#define otau otau_cagkBC
 double otau = 0;
#define oinf oinf_cagkBC
 double oinf = 0;
#define st st_cagkBC
 double st = 1;
 ...
 "cai_cagkBC", &cai_cagkBC,
 "d1_cagkBC", &d1_cagkBC,
 "d2_cagkBC", &d2_cagkBC,
 "k1_cagkBC", &k1_cagkBC,
 "k2_cagkBC", &k2_cagkBC,
 "abar_cagkBC", &abar_cagkBC,
 "bbar_cagkBC", &bbar_cagkBC,
 "st_cagkBC", &st_cagkBC,
 "oinf_cagkBC", &oinf_cagkBC,
 "otau_cagkBC", &otau_cagkBC,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "cvodeieq");
 	...
 	ivoc_help("help ?1 cagkBC /home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/x86_64/Cagk_BC.mod\n");
 ...
 v=_v;
{
  ...
  ek = _ion_ek;
 { error =  state();
 if(error){fprintf(stderr,"at line 63 in file Cagk_BC.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/modfiles/Cagk_BC.mod";
static const char* nmodl_file_text = 
  "TITLE CaGk\n"
