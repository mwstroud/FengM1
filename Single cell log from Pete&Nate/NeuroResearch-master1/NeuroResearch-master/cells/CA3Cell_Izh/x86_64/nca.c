...
#define nrn_init _nrn_init__ncaDG
#define _nrn_initial _nrn_initial__ncaDG
#define nrn_cur _nrn_cur__ncaDG
#define _nrn_current _nrn_current__ncaDG
#define nrn_jacob _nrn_jacob__ncaDG
#define nrn_state _nrn_state__ncaDG
#define _net_receive _net_receive__ncaDG 
#define _f_trates _f_trates__ncaDG 
#define rates rates__ncaDG 
#define states states__ncaDG 
#define trates trates__ncaDG 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_ncaDG", _hoc_setdata,
 "rates_ncaDG", _hoc_rates,
 "states_ncaDG", _hoc_states,
 "trates_ncaDG", _hoc_trates,
 "vtrap_ncaDG", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_ncaDG
 extern double vtrap( double , double );
 /* declare global and static user variables */
#define usetable usetable_ncaDG
 double usetable = 1;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "nca_ion");
 	...
 	ivoc_help("help ?1 ncaDG /home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/x86_64/nca.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("ncaDG", "cannot be used with CVODE"); return 0;}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/modfiles/nca.mod";
static const char* nmodl_file_text = 
  "TITLE nca.mod  \n"
  " \n"
  "COMMENT\n"
