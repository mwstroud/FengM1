...
#define nrn_init _nrn_init__lcaOLM
#define _nrn_initial _nrn_initial__lcaOLM
#define nrn_cur _nrn_cur__lcaOLM
#define _nrn_current _nrn_current__lcaOLM
#define nrn_jacob _nrn_jacob__lcaOLM
#define nrn_state _nrn_state__lcaOLM
#define _net_receive _net_receive__lcaOLM 
#define rate rate__lcaOLM 
#define state state__lcaOLM 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_lcaOLM", _hoc_setdata,
 "KTF_lcaOLM", _hoc_KTF,
 "alp_lcaOLM", _hoc_alp,
 "bet_lcaOLM", _hoc_bet,
 "efun_lcaOLM", _hoc_efun,
 "ghk_lcaOLM", _hoc_ghk,
 "h2_lcaOLM", _hoc_h2,
 "rate_lcaOLM", _hoc_rate,
 0, 0
};
#define KTF KTF_lcaOLM
#define _f_bet _f_bet_lcaOLM
#define _f_alp _f_alp_lcaOLM
#define alp alp_lcaOLM
#define bet bet_lcaOLM
#define efun efun_lcaOLM
#define ghk ghk_lcaOLM
#define h2 h2_lcaOLM
...
#define ki ki_lcaOLM
 double ki = 0.001;
#define matu matu_lcaOLM
 double matu = 0;
#define minf minf_lcaOLM
 double minf = 0;
#define tfa tfa_lcaOLM
 double tfa = 1;
#define usetable usetable_lcaOLM
 double usetable = 1;
 ...
 "ki_lcaOLM", &ki_lcaOLM,
 "tfa_lcaOLM", &tfa_lcaOLM,
 "minf_lcaOLM", &minf_lcaOLM,
 "matu_lcaOLM", &matu_lcaOLM,
 "usetable_lcaOLM", &usetable_lcaOLM,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 lcaOLM /home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/x86_64/Lca_OLM.mod\n");
 ...
 v=_v;
{
  ...
  cao = _ion_cao;
 { error =  state();
 if(error){fprintf(stderr,"at line 56 in file Lca_OLM.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/modfiles/Lca_OLM.mod";
static const char* nmodl_file_text = 
