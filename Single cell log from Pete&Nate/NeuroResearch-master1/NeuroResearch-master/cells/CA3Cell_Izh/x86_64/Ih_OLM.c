...
#define nrn_init _nrn_init__IhOLM
#define _nrn_initial _nrn_initial__IhOLM
#define nrn_cur _nrn_cur__IhOLM
#define _nrn_current _nrn_current__IhOLM
#define nrn_jacob _nrn_jacob__IhOLM
#define nrn_state _nrn_state__IhOLM
#define _net_receive _net_receive__IhOLM 
#define _f_rates _f_rates__IhOLM 
#define deriv deriv__IhOLM 
#define rates rates__IhOLM 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_IhOLM", _hoc_setdata,
 "rates_IhOLM", _hoc_rates,
 0, 0
};
 /* declare global and static user variables */
#define p p_IhOLM
 double p = 5;
#define rexp rexp_IhOLM
 double rexp = 0;
#define rinf rinf_IhOLM
 double rinf = 0;
#define tau_r tau_r_IhOLM
 double tau_r = 0;
#define usetable usetable_IhOLM
 double usetable = 1;
 ...
 "p_IhOLM", &p_IhOLM,
 "rinf_IhOLM", &rinf_IhOLM,
 "rexp_IhOLM", &rexp_IhOLM,
 "tau_r_IhOLM", &tau_r_IhOLM,
 "usetable_IhOLM", &usetable_IhOLM,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 IhOLM /home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/x86_64/Ih_OLM.mod\n");
...
_deriv1_advance = 0;
 if(error){fprintf(stderr,"at line 83 in file Ih_OLM.mod:\n        SOLVE deriv METHOD derivimplicit\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 1; ++_i) {
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/pbcanfield/Desktop/NeuroResearch/CA3Cell_Izh/modfiles/Ih_OLM.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
