...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 IhOLM I:/SkyDrive/Nair Lab/Pete/NeuroResearch-master1/NeuroResearch-master/cells/SOMCell/OLM_Ih.mod\n");
...
_deriv1_advance = 0;
 if(error){fprintf(stderr,"at line 83 in file OLM_Ih.mod:\n        SOLVE deriv METHOD derivimplicit\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 1; ++_i) {
