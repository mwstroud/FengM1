...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 8, "ks_ion");
 	...
 	ivoc_help("help ?1 ichan2OLM I:/SkyDrive/Nair Lab/Pete/NeuroResearch-master1/NeuroResearch-master/cells/SOMCell/OLM_ichan2.mod\n");
 ...
 v=_v;
{
  ...
  eks = _ion_eks;
 { error =  states();
 if(error){fprintf(stderr,"at line 72 in file OLM_ichan2.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 }   }}
